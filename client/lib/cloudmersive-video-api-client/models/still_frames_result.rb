...
module CloudmersiveVideoApiClient
  ...
  class StillFramesResult
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'StillFrames')
        if (value = attributes[:'StillFrames']).is_a?(Array)
          self.still_frames = value
        end
      end
    end
    ...
    def hash
      [successful, total_frames, still_frames].hash
    end
